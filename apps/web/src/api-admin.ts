/** RPC admin via `hcApi` — sama-origin + cookie better-auth (`apps/web/src/lib/hono-client.ts`, `@mainceria/api-client`). */
...
/** Bundle metrik MVP — selaras dengan `AdminAnalyticsBundle` di API */
